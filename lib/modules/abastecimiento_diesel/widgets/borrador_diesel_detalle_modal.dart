    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          if (borrador.kilometraje != null) _buildInfoRow('Kilometraje', '${borrador.kilometraje} km'),
          if (borrador.horometro != null) _buildInfoRow('Horómetro', '${borrador.horometro!.toStringAsFixed(1)} hrs'),
